...
<head>
	...
	<title>Halo <%=session.getAttribute("nim_asisten")%> - List Ajuan Laporan</title>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">List Ajuan Laporan</a>
                </div>
        ...
        <table id="listlaporan" cellspacing="0" width="100%">
            <thead>
                <tr>
                <td>Kode Laporan</td>
                <td>NIM Pelapor</td>
            ...
            <c:forEach var="user" items="${listUsers.rows}">
                ...
                <tr>
                    ...
                    <td><a href="ubahlaporan.jsp?kode_laporan=<c:out value="${user.kode_laporan}" />">Ubah</a> | <a href="hapusasisten.jsp?nim=<c:out value="${user.nim_asisten}" />">Delete</a></td>
                </tr>
                </tbody>
            </c:forEach>
        </table>
