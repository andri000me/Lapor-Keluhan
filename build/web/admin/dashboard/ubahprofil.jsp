...
<head>
	...
	<title>Halo <%=session.getAttribute("nim_asisten")%> - Ubah Profil</title>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <form method="post" action="updateprofil.jsp">
                ...
                <div class="form-group">
                <select class="form-control" name="slcjabatan">
                <option selected="<c:out value="${user.jabatan}"/>" readonly><c:out value="${user.jabatan}"/></option>
