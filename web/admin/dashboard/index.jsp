...
<head>
	...
	<title>Halo <%=session.getAttribute("nim_asisten")%> ! - Dashboard</title>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Dashboard Profil</a>
                </div>
	    ...
	    response.sendRedirect(redirectURL);
            ...
            <%} else {
            %>
            <h3> Berikut Data yang terdapat dalam Database Pengaduan Online.</h3>
