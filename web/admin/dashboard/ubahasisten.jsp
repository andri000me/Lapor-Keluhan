<%-- 
    Document   : ubahasisten
    Created on : Oct 7, 2016, 11:07:19 PM
    Author     : RyfanAditya
--%>
...
<head>
	...
	<title>Halo <%=session.getAttribute("nim_asisten")%> - Ubah Asisten</title>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        SELECT * FROM asisten WHERE nim_asisten="<%=request.getParameter("nim")%>";
    </sql:query>
    
        <form method="post" action="updateasisten.jsp">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="txtjabatan" placeholder="Jabatan" value="<c:out value="${user.jabatan}"/>">
                </div>
                <div class="form-group">
                  <input type="number" class="form-control" name="txtnohp" placeholder="No Handphone" value="<c:out value="${user.no_hp}"/>">
                </div>
                    <center><input type="submit" name="cmdubahasisten" value="Ubah Profil Asisten" class="btn btn-primary"></center>
                    </c:forEach>
              </form>
            <%
            }
