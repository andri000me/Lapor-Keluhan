<%-- 
    Document   : mastermahasiswa
    Created on : Oct 7, 2016, 6:19:59 PM
    Author     : RyfanAditya
--%>
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Master Data Mahasiswa</a>
                </div>
        ...
        <table id="mahasiswa" cellspacing="0" width="100%">
            ...
            <c:forEach var="user" items="${listUsers.rows}">
                <tbody>
                <tr>
                    <td><c:out value="${user.nim_mhs}" /></td>
                    <td><c:out value="${user.password}" /></td>
                    <td><c:out value="${user.nama}" /></td>
                    <td><c:out value="${user.jurusan}" /></td>
                    <td><c:out value="${user.no_hp}" /></td>
                    <td><a href="ubahmahasiswa.jsp?nim=<c:out value="${user.nim_mhs}" />">Ubah</a> | <a href="hapusmahasiswa.jsp?nim=<c:out value="${user.nim_mhs}" />">Delete</a></td>
                </tr>
                </tbody>
            </c:forEach>
        </table>
